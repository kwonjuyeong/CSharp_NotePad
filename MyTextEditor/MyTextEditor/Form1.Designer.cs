namespace MyTextEditor
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            fileToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { 새파일ToolStripMenuItem, 새창ToolStripMenuItem, 열기ToolStripMenuItem, 저장ToolStripMenuItem, 다른이름으로저장ToolStripMenuItem, 페이지설정ToolStripMenuItem, 인쇄ToolStripMenuItem, 끝내기ToolStripMenuItem });
            ...
            // 
            편집EToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { 실행취소ToolStripMenuItem, 잘라내기ToolStripMenuItem, 복사ToolStripMenuItem, 붙여넣기ToolStripMenuItem, 삭제ToolStripMenuItem, 찾기ToolStripMenuItem, 다음찾기ToolStripMenuItem, 이전찾기ToolStripMenuItem, 바꾸기ToolStripMenuItem, 이동ToolStripMenuItem, 모두선택ToolStripMenuItem, 시간날짜ToolStripMenuItem });
            ...
            새파일ToolStripMenuItem.Size = new Size(180, 22);
            ...
            새창ToolStripMenuItem.Size = new Size(180, 22);
            ...
            자동줄바꿈ToolStripMenuItem.Size = new Size(180, 22);
